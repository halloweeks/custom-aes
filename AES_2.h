...
/*
static inline void AES_EncryptInit(AES_CTX *ctx, const unsigned char *key) {
	ctx->roundkey[0] = GETU32(key + 0);
	ctx->roundkey[1] = GETU32(key + 4);
	ctx->roundkey[2] = GETU32(key + 8);
	ctx->roundkey[3] = GETU32(key + 12);
	
	ctx->roundkey[4] = ctx->roundkey[0] ^ 
        (Te4[(ctx->roundkey[3] >> 16) & 0xff] & 0xff000000) ^ 
        (Te4[(ctx->roundkey[3] >> 8) & 0xff] & 0x00ff0000) ^ 
        (Te4[(ctx->roundkey[3] >> 0) & 0xff] & 0x0000ff00) ^ 
        (Te4[(ctx->roundkey[3] >> 24) & 0xff] & 0x000000ff) ^ rcon[0];
    ctx->roundkey[5] = ctx->roundkey[1] ^ ctx->roundkey[4];
    ctx->roundkey[6] = ctx->roundkey[2] ^ ctx->roundkey[5];
    ctx->roundkey[7] = ctx->roundkey[3] ^ ctx->roundkey[6];

    ctx->roundkey[8] = ctx->roundkey[4] ^ 
        (Te4[(ctx->roundkey[7] >> 16) & 0xff] & 0xff000000) ^ 
        (Te4[(ctx->roundkey[7] >> 8) & 0xff] & 0x00ff0000) ^ 
        (Te4[(ctx->roundkey[7] >> 0) & 0xff] & 0x0000ff00) ^ 
        (Te4[(ctx->roundkey[7] >> 24) & 0xff] & 0x000000ff) ^ rcon[1];
    ctx->roundkey[9] = ctx->roundkey[5] ^ ctx->roundkey[8];
    ctx->roundkey[10] = ctx->roundkey[6] ^ ctx->roundkey[9];
    ctx->roundkey[11] = ctx->roundkey[7] ^ ctx->roundkey[10];

    ctx->roundkey[12] = ctx->roundkey[8] ^ 
        (Te4[(ctx->roundkey[11] >> 16) & 0xff] & 0xff000000) ^ 
        (Te4[(ctx->roundkey[11] >> 8) & 0xff] & 0x00ff0000) ^ 
        (Te4[(ctx->roundkey[11] >> 0) & 0xff] & 0x0000ff00) ^ 
        (Te4[(ctx->roundkey[11] >> 24) & 0xff] & 0x000000ff) ^ rcon[2];
    ctx->roundkey[13] = ctx->roundkey[9] ^ ctx->roundkey[12];
    ctx->roundkey[14] = ctx->roundkey[10] ^ ctx->roundkey[13];
    ctx->roundkey[15] = ctx->roundkey[11] ^ ctx->roundkey[14];
    
    ctx->roundkey[16] = ctx->roundkey[12] ^ 
        (Te4[(ctx->roundkey[15] >> 16) & 0xff] & 0xff000000) ^ 
        (Te4[(ctx->roundkey[15] >> 8) & 0xff] & 0x00ff0000) ^ 
        (Te4[(ctx->roundkey[15] >> 0) & 0xff] & 0x0000ff00) ^ 
        (Te4[(ctx->roundkey[15] >> 24) & 0xff] & 0x000000ff) ^ rcon[3];
    ctx->roundkey[17] = ctx->roundkey[13] ^ ctx->roundkey[16];
    ctx->roundkey[18] = ctx->roundkey[14] ^ ctx->roundkey[17];
    ctx->roundkey[19] = ctx->roundkey[15] ^ ctx->roundkey[18];
    
    ctx->roundkey[20] = ctx->roundkey[16] ^ 
        (Te4[(ctx->roundkey[19] >> 16) & 0xff] & 0xff000000) ^ 
        (Te4[(ctx->roundkey[19] >> 8) & 0xff] & 0x00ff0000) ^ 
        (Te4[(ctx->roundkey[19] >> 0) & 0xff] & 0x0000ff00) ^ 
        (Te4[(ctx->roundkey[19] >> 24) & 0xff] & 0x000000ff) ^ rcon[4];
    ctx->roundkey[21] = ctx->roundkey[17] ^ ctx->roundkey[20];
    ctx->roundkey[22] = ctx->roundkey[18] ^ ctx->roundkey[21];
    ctx->roundkey[23] = ctx->roundkey[19] ^ ctx->roundkey[22];
    
    ctx->roundkey[24] = ctx->roundkey[20] ^ 
        (Te4[(ctx->roundkey[23] >> 16) & 0xff] & 0xff000000) ^ 
        (Te4[(ctx->roundkey[23] >> 8) & 0xff] & 0x00ff0000) ^ 
        (Te4[(ctx->roundkey[23] >> 0) & 0xff] & 0x0000ff00) ^ 
        (Te4[(ctx->roundkey[23] >> 24) & 0xff] & 0x000000ff) ^ rcon[5];
    ctx->roundkey[25] = ctx->roundkey[21] ^ ctx->roundkey[24];
    ctx->roundkey[26] = ctx->roundkey[22] ^ ctx->roundkey[25];
    ctx->roundkey[27] = ctx->roundkey[23] ^ ctx->roundkey[26];
    
    ctx->roundkey[28] = ctx->roundkey[24] ^ 
        (Te4[(ctx->roundkey[27] >> 16) & 0xff] & 0xff000000) ^ 
        (Te4[(ctx->roundkey[27] >> 8) & 0xff] & 0x00ff0000) ^ 
        (Te4[(ctx->roundkey[27] >> 0) & 0xff] & 0x0000ff00) ^ 
        (Te4[(ctx->roundkey[27] >> 24) & 0xff] & 0x000000ff) ^ rcon[6];
    ctx->roundkey[29] = ctx->roundkey[25] ^ ctx->roundkey[28];
    ctx->roundkey[30] = ctx->roundkey[26] ^ ctx->roundkey[29];
    ctx->roundkey[31] = ctx->roundkey[27] ^ ctx->roundkey[30];
    
    ctx->roundkey[32] = ctx->roundkey[28] ^ 
        (Te4[(ctx->roundkey[31] >> 16) & 0xff] & 0xff000000) ^ 
        (Te4[(ctx->roundkey[31] >> 8) & 0xff] & 0x00ff0000) ^ 
        (Te4[(ctx->roundkey[31] >> 0) & 0xff] & 0x0000ff00) ^ 
        (Te4[(ctx->roundkey[31] >> 24) & 0xff] & 0x000000ff) ^ rcon[7];
    ctx->roundkey[33] = ctx->roundkey[29] ^ ctx->roundkey[32];
    ctx->roundkey[34] = ctx->roundkey[30] ^ ctx->roundkey[33];
    ctx->roundkey[35] = ctx->roundkey[31] ^ ctx->roundkey[34];
    
    ctx->roundkey[36] = ctx->roundkey[32] ^ 
        (Te4[(ctx->roundkey[35] >> 16) & 0xff] & 0xff000000) ^ 
        (Te4[(ctx->roundkey[35] >> 8) & 0xff] & 0x00ff0000) ^ 
        (Te4[(ctx->roundkey[35] >> 0) & 0xff] & 0x0000ff00) ^ 
        (Te4[(ctx->roundkey[35] >> 24) & 0xff] & 0x000000ff) ^ rcon[8];
    ctx->roundkey[37] = ctx->roundkey[33] ^ ctx->roundkey[36];
    ctx->roundkey[38] = ctx->roundkey[34] ^ ctx->roundkey[37];
    ctx->roundkey[39] = ctx->roundkey[35] ^ ctx->roundkey[38];
    
    ctx->roundkey[40] = ctx->roundkey[36] ^ 
        (Te4[(ctx->roundkey[39] >> 16) & 0xff] & 0xff000000) ^ 
        (Te4[(ctx->roundkey[39] >> 8) & 0xff] & 0x00ff0000) ^ 
        (Te4[(ctx->roundkey[39] >> 0) & 0xff] & 0x0000ff00) ^ 
        (Te4[(ctx->roundkey[39] >> 24) & 0xff] & 0x000000ff) ^ rcon[9];
    ctx->roundkey[41] = ctx->roundkey[37] ^ ctx->roundkey[40];
    ctx->roundkey[42] = ctx->roundkey[38] ^ ctx->roundkey[41];
    ctx->roundkey[43] = ctx->roundkey[39] ^ ctx->roundkey[42];
}
*/
...
static inline void AES_DecryptInit(AES_CTX *ctx, const unsigned char *key) {
...
static inline unsigned int AES_Encrypt(const AES_CTX *ctx, const unsigned char *in_data, unsigned int in_size, unsigned char *out_data) {
	unsigned int s0, s1, s2, s3, t0, t1, t2, t3, offset;
	
	unsigned int block[4];
	
	block[0] = ctx->roundkey[40];
	block[1] = ctx->roundkey[41];
	block[2] = ctx->roundkey[42];
	block[3] = ctx->roundkey[43];
	
	
	for (offset = 0; offset + AES_BLOCK_SIZE <= in_size; offset += AES_BLOCK_SIZE) {
		/*s0 = GETU32(in_data + offset +  0) ^ ctx->roundkey[0];
		s1 = GETU32(in_data + offset +  4) ^ ctx->roundkey[1];
		s2 = GETU32(in_data + offset +  8) ^ ctx->roundkey[2];
		s3 = GETU32(in_data + offset + 12) ^ ctx->roundkey[3];
		*/
		
		s0 = GETU32(in_data + offset +  0);
		s1 = GETU32(in_data + offset +  4);
		s2 = GETU32(in_data + offset +  8);
		s3 = GETU32(in_data + offset + 12);
		...
		s0 = 
			...
			(Te4[(t3 >>  0) & 0xff] & 0x000000ff) ^ ctx->roundkey[40];
		PUTU32(out_data + offset, s0);
		
		s1 = 
			(Te4[(t1 >> 24) & 0xff] & 0xff000000) ^
			(Te4[(t2 >> 16) & 0xff] & 0x00ff0000) ^
			(Te4[(t3 >>  8) & 0xff] & 0x0000ff00) ^
			(Te4[(t0 >>  0) & 0xff] & 0x000000ff) ^ ctx->roundkey[41];
		PUTU32(out_data + offset + 4, s1);
		
		s2 = 
			(Te4[(t2 >> 24) & 0xff] & 0xff000000) ^
			(Te4[(t3 >> 16) & 0xff] & 0x00ff0000) ^
			(Te4[(t0 >>  8) & 0xff] & 0x0000ff00) ^
			(Te4[(t1 >>  0) & 0xff] & 0x000000ff) ^ ctx->roundkey[42];
		PUTU32(out_data + offset + 8, s2);
		
		s3 = 
			(Te4[(t3 >> 24) & 0xff] & 0xff000000) ^
			(Te4[(t0 >> 16) & 0xff] & 0x00ff0000) ^
			(Te4[(t1 >>  8) & 0xff] & 0x0000ff00) ^
			(Te4[(t2 >>  0) & 0xff] & 0x000000ff) ^ ctx->roundkey[43];
		PUTU32(out_data + offset + 12, s3);
...
static inline unsigned int AES_Decrypt(const AES_CTX *ctx, const unsigned char *out_data, unsigned int out_size, unsigned char *in_data) {
	unsigned int s0, s1, s2, s3, t0, t1, t2, t3, offset;
	
	unsigned int block[4];
	unsigned int prev_block[4];
	
	block[0] = ctx->roundkey[0];
	block[1] = ctx->roundkey[1];
	block[2] = ctx->roundkey[2];
	block[3] = ctx->roundkey[3];
	
	for (offset = 0; offset + AES_BLOCK_SIZE <= out_size; offset += AES_BLOCK_SIZE) {
		/*
		s0 = GETU32(out_data + offset) ^ ctx->roundkey[0];
		s1 = GETU32(out_data + offset + 4) ^ ctx->roundkey[1];
		s2 = GETU32(out_data + offset + 8) ^ ctx->roundkey[2];
		s3 = GETU32(out_data + offset + 12) ^ ctx->roundkey[3];
		*/
		
		s0 = GETU32(out_data + offset);
		s1 = GETU32(out_data + offset + 4);
		s2 = GETU32(out_data + offset + 8);
		s3 = GETU32(out_data + offset + 12);
		...
		PUTU32(in_data + offset, s0);
		PUTU32(in_data + offset + 4, s1);
		PUTU32(in_data + offset + 8, s2);
		PUTU32(in_data + offset + 12, s3);
		
		block[0] = prev_block[0];
		block[1] = prev_block[1];
		block[2] = prev_block[2];
		block[3] = prev_block[3];
